...
class CalculatorTest {
	...
	void simpleTest() {
		...
		Node divNode = new DivideNode(value2,value3);
		addNode = new AddNode(value1,divNode);
		assertEquals(addNode.evaluate(),2.0/3+1);
		
		Node subNode = new SubtractNode(value3,value2);
		addNode = new AddNode(value1,subNode);
