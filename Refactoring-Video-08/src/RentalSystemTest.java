...
class RentalSystemTest {
	...
	void rentalBasicTest() {
		...
		sangjin.addRental(new Rental(new Movie("알라딘", PriceCode.CHILDRENS),2));
		sangjin.addRental(new Rental(new Movie("블랙위도우", PriceCode.NEW_RELEASE),2));
	...
	void rentalAdvancedTest() {
		...
		sangjin.addRental(new Rental(new Movie("소율", PriceCode.CHILDRENS),4));
		sangjin.addRental(new Rental(new Movie("크루엘라", PriceCode.NEW_RELEASE),3));
		String expectedResult = 
			"고객 김상진님의 대여목록:\n"+
			"\t어벤져스: 엔드게임\t5,000원\n" +
			"\t소율\t3,000원\n" +
